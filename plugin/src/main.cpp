...
#define INKAY_VERSION "v0.0.4"

/**
    Mandatory plugin information.
    If not set correctly, the loader will refuse to use the plugin.
**/
WUPS_PLUGIN_NAME("Electrode");
WUPS_PLUGIN_DESCRIPTION("Samtendo Network Patcher");
WUPS_PLUGIN_VERSION(INKAY_VERSION);
WUPS_PLUGIN_AUTHOR("Samtendo contributors");
WUPS_PLUGIN_LICENSE("GPLv3");

WUPS_USE_STORAGE("electrode");
