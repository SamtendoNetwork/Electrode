...
static const URL_Patch url_patches[] = {
        ...
        {0xE2299990, "nppl.app.samtendo.net"},
        ...
        {0xE229B1F4, "https://npts.app.samtendo.net/p01/tasksheet/%s/%s/%s/%s?c=%s&l=%s"},
        {0xE229B238, "https://npts.app.samtendo.net/p01/tasksheet/%s/%s/%s?c=%s&l=%s"},
        ...
        //nim-boss .bss
        {0xE24B8A24, "https://nppl.app.samtendo.net/p01/policylist/1/1/UNK"},
